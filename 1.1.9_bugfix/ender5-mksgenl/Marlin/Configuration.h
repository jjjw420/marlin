...
#define STRING_CONFIG_H_AUTHOR "(Ender-5)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 434.36
  #define DEFAULT_bedKi 81.58
  #define DEFAULT_bedKd 578.18
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.9 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.600   // Z offset: -below +above  [the nozzle]
 ...
 * probe   set with Z_PROBE_OFFSET_FROM_EXTRUDER, M851, or the LCD.
...
#define LCD_BED_LEVELING
  ...
  #define MBL_Z_STEP 0.005    // Step size while manually probing Z axis.
...
// http://reprap.org/wiki/RepRapDiscount_Full_Graphic_Smart_Cont+roller
//
