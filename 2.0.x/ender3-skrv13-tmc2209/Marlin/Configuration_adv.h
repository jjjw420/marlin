 ...
 */
  ...
  #define MIN_PROBE_EDGE_FRONT MIN_PROBE_EDGE + 25
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       581        // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Upgrade firmware"
